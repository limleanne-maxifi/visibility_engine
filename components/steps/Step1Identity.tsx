...
export default function Step1Identity({ data, onChange, onNext, errors }: Props) {
  ...
  return (
    <form onSubmit={handleSubmit} noValidate>
      ...
      <div className="space-y-4">
        ...
        <div>
          ...
          {errors.websiteUrl ? (
            ...
            <p className="mt-1 text-xs text-gray-400">Needed for your site-level AI audit.</p>
          )}
        </div>
      </div>
      ...
      <button
        type="submit"
        className="mt-6 w-full py-[13px] px-6 bg-[#C87A2F] hover:bg-[#A8651E] text-white text-sm font-bold rounded-lg transition-colors"
      >
        Continue →
      </button>
    </form>

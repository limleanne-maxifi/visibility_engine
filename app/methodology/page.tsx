      ...
      <div className="max-w-[680px] mx-auto">
        ...
        <div className="bg-white rounded-xl border border-gray-100 shadow-sm p-7 mb-10">
          ...
          <div className="space-y-4">
            {[
              {
                label: 'Discrepancy reporting',
                body: 'Users who verify their prediction and find a mismatch can report it directly from the snapshot. Each discrepancy report is reviewed and used to refine the scoring logic.',
              },
              {
